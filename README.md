...
相关介绍和操作可参考: [加入搜索功能](http://roweb.cn/2017/05/09/Jekyll-second/#加入搜索功能)

### 提供百度统计功能

博客使用[百度统计](https://tongji.baidu.com/web/welcome/login)提供统计功能。具体操作方法在官网有详细介绍。

相关介绍和操作可参考: [添加网站统计](http://roweb.cn/2017/05/09/Jekyll-second/#添加网站统计)

### 提供不蒜子pv/uv计数器

[不蒜子](http://busuanzi.ibruce.info/)可以提供pv/uv的计数。好处在于可以在界面上显示访问量。

相关介绍和操作可参考: [网页的pv/uv计数器](http://roweb.cn/2017/05/09/Jekyll-second/#网页的pvuv计数器)
...
相关介绍和操作可参考: [社会化评论](http://roweb.cn/2017/05/09/Jekyll-second/#社会化网页评论)

### 使用canvas实现首页动态效果

### 使用日历控件显示当前日期

[在线演示](http://roweb.cn/effects/demo/demo-calender/index.html)

### 使用tagCloud控件实现云标签效果

[在线演示](http://roweb.cn/effects/demo/demo-tagscloud/index.html)
...
+ [基于Jekyll静态框架的Github站点设计](http://roweb.cn/2017/02/22/Jekyll-Cpanel/)
+ [Jekyll搭建博客--人类补完计划](http://roweb.cn/2017/05/09/Jekyll-second/)

### 部署和安装

请参考[Jekyll相关](http://roweb.cn/2017/02/22/Jekyll-Cpanel/#jekyll相关)。
...
多tag可参考文章:[加入多个标签](http://roweb.cn/2017/05/09/Jekyll-second/#如何加入多个标签)
...
> 备注: 草稿区的内容不会显示，如果想要对草稿去内容进行查看，可参考[开启草稿](http://roweb.cn/2017/05/09/Jekyll-second/#jekyll的一些使用技巧)
